...
Calculation inputs: **26–30 blocks/month × k**, with **k = 5 or 20**. Monthly token allowances are not published in the cited sources.

| Tier | Blocks/month | API equivalent | At 28 × k blocks | API equivalent / price |
| --- | ---: | ---: | ---: | ---: |
| Pro 5× | 130–150 | **$975–$1,125** | $1,050 | **9.75–11.25×** |
| Pro 20× | 520–600 | **$3,900–$4,500** | $4,200 | **19.5–22.5×** |

INR calculations at 140 / 560 blocks and ₹90/$: **₹94,500 / ₹3,78,000**, against converted subscriptions of **₹9,000 / ₹18,000**.

## Additional calculations and limits

* API break-even: **13.33 / 26.67 blocks/month** for Pro 5× / 20×.
* At the same **28 blocks/month**, either tier replaces **$210** of API usage: **2.10× / 1.05×** its price.
